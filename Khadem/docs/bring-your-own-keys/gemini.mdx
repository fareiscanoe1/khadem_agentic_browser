---
title: "Gemini"
description: "Configure Khadem to use Google's Gemini AI model"
---

Gemini 2.5 Flash is fast, powerful, and free. Google AI Studio gives you 20 requests per minute at no cost - perfect for Khadem.
...
Click the settings icon in Khadem, then click **USE** on the Gemini card.
...
Done! You're ready to use Khadem with Gemini.