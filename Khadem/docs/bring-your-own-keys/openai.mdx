---
title: "OpenAI"
description: "Configure Khadem to use OpenAI's GPT models"
---
...
Click the settings icon in Khadem, then click **USE** on the OpenAI card. Paste your API key and configure the settings based on your chosen model. For GPT-4.1, set **Context Window Size** to `128000` and check **Supports Images**. Click **Save**.

![image.png](/docs/images/image.png)

Done! You're ready to use Khadem with OpenAI.