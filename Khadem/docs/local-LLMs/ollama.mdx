...
description: "Configure Ollama to work with Khadem for local AI capabilities"
icon: "robot"
---
...
<Steps>
  <Step title="Navigate to AI Settings">
    Navigate to `chrome://settings/khadem` to add Ollama as a provider.
  </Step>
...
Navigate to the Khadem AI settings page at `chrome://settings/khadem-ai`
...
Run Ollama with the required CORS settings to allow Khadem to connect:
