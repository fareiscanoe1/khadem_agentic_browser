...
description: "Get started with Khadem in 2 simple steps"
---
...
Khadem comes with a default LLM provider to test things out. But you have full control over your AI models! Navigate to `New Tab` page or `chrome://settings/khadem` and click on settings to configure your own API keys for various providers.
...
You're ready to use Khadem! This page can always be accessed again at `chrome://khadem-first-run`
