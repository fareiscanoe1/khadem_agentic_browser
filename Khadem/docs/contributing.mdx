...
<CardGroup cols={3}>
  <Card
    ...
    icon="github"
    href="https://github.com/Khadem/Khadem"
  >
  ...
  <Card
    title="Report Issues"
    icon="bug"
    href="https://github.com/Khadem/Khadem/issues"
  >
...
You can contribute to Khadem in many ways! Whether you want to build features or help out in other ways, we appreciate all contributions.
...
<Steps>
  ...
  <Step title="Load Unpacked Extension">
    Click **Load unpacked** and select `packages/khadem-agent/dist/`
  </Step>
...
<Note>
For detailed setup, architecture, and code standards, see the [Agent Contributing Guide](https://github.com/Khadem/Khadem/blob/main/packages/khadem-agent/CONTRIBUTING.md).
</Note>
...
<Steps>
  ...
  <Step title="Run Khadem">
    After the build completes successfully, you can run Khadem:

    <Tabs>
      <Tab title="macOS Debug (ARM64)">
        ```bash
        out/Default_arm64/Khadem\ Dev.app/Contents/MacOS/Khadem\ Dev --user-data-dir=/tmp/test-profile
        ```
      </Tab>
      <Tab title="macOS Debug (x64)">
        ```bash
        out/Default_x64/Khadem\ Dev.app/Contents/MacOS/Khadem\ Dev --user-data-dir=/tmp/test-profile
        ```
      </Tab>
      <Tab title="macOS Release (ARM64)">
        ```bash
        out/Default_arm64/Khadem.app/Contents/MacOS/Khadem --user-data-dir=/tmp/test-profile
        ```
      </Tab>
      <Tab title="macOS Release (x64)">
        ```bash
        out/Default_x64/Khadem.app/Contents/MacOS/Khadem --user-data-dir=/tmp/test-profile
        ```
      </Tab>
...
<Steps>
  <Step title="Read the CLA">
    Read the [CLA document](https://github.com/Khadem/Khadem/blob/main/CLA.md)
  </Step>
...
- Agent: [packages/khadem-agent/CLAUDE.md](https://github.com/Khadem/Khadem/blob/main/packages/khadem-agent/CLAUDE.md)
</Note>
...
<Steps>
  <Step title="Fork and Clone">
    ...
    ```bash
    git clone https://github.com/YOUR-USERNAME/Khadem.git
    cd Khadem
    ```
  </Step>
...
<CardGroup cols={3}>
  ...
  <Card
    title="GitHub Issues"
    icon="bug"
    href="https://github.com/khadem-ai/Khadem/issues"
  >
  ...
  <Card
    ...
    icon="comments"
    href="https://github.com/khadem-ai/Khadem/discussions"
  >
    General questions
  </Card>
</CardGroup>
