diff --git a/components/metrics/khadem_metrics/khadem_metrics.h b/components/metrics/khadem_metrics/khadem_metrics.h
new file mode 100644
index 0000000000000..73e98afdaa28a
--- /dev/null
+++ b/components/metrics/khadem_metrics/khadem_metrics.h
@@ -0,0 +1,40 @@
+// Copyright 2025 The Chromium Authors
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#ifndef COMPONENTS_METRICS_KHADEM_METRICS_KHADEM_METRICS_H_
+#define COMPONENTS_METRICS_KHADEM_METRICS_KHADEM_METRICS_H_
+
+#include <string>
+#include <utility>
+
...
+
+// Simple static API for logging Khadem metrics.
+// Usage: KhademMetrics::Log("event.name");
+class KhademMetrics {
+ public:
...
+
+ private:
+  KhademMetrics() = delete;
+};
+
+}  // namespace khadem_metrics
+
+#endif  // COMPONENTS_METRICS_KHADEM_METRICS_KHADEM_METRICS_H_
