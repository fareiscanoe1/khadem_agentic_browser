...
+const base::FilePath::CharType kBrowserProcessExecutableName[] = FPL("khadem");
...
-const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("chrome");
-const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("chrome");
+const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("khadem");
+const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("khadem");
 #endif  // OS_*
...
+const base::FilePath::CharType kBrowserResourcesDll[] = FPL("khadem.dll");
+const base::FilePath::CharType kElfDll[] = FPL("khadem_elf.dll");
