...
+  // Browser OS API
+  registry->RegisterFunction<api::KhademGetAccessibilityTreeFunction>();
+  registry->RegisterFunction<api::KhademGetInteractiveSnapshotFunction>();
+  registry->RegisterFunction<api::KhademClickFunction>();
+  registry->RegisterFunction<api::KhademInputTextFunction>();
+  registry->RegisterFunction<api::KhademClearFunction>();
+  registry->RegisterFunction<api::KhademExecuteJavaScriptFunction>();
+
