...
+class KhademChangeDetector : public content::WebContentsObserver {
+ public:
...
+  explicit KhademChangeDetector(content::WebContents* web_contents);
+  ~KhademChangeDetector() override;
+
+ private:
+  KhademChangeDetector(const KhademChangeDetector&) = delete;
+  KhademChangeDetector& operator=(const KhademChangeDetector&) = delete;
+
...
+  base::WeakPtrFactory<KhademChangeDetector> weak_factory_{this};
+};
+
+}  // namespace api
+}  // namespace extensions
