...
+  (*s_allowlist)[prefs::kKhademProviders] = settings_api::PrefType::kString;
...
+
+  // Khadem preferences
+  (*s_allowlist)[prefs::kKhademShowToolbarLabels] = settings_api::PrefType::kBoolean;
+  (*s_allowlist)[prefs::kKhademCustomProviders] = settings_api::PrefType::kString;
+
