diff --git a/chrome/browser/khadem_server/khadem_server_prefs.cc b/chrome/browser/khadem_server/khadem_server_prefs.cc
new file mode 100644
index 0000000000000..f9c7a9990cb01
--- /dev/null
+++ b/chrome/browser/khadem_server/khadem_server_prefs.cc
@@ -0,0 +1,49 @@
...
+const char kCDPServerPort[] = "khadem.server.cdp_port";
+
+// MCP server port (HTTP)
+const char kMCPServerPort[] = "khadem.server.mcp_port";
+
+// Agent server port
+const char kAgentServerPort[] = "khadem.server.agent_port";
+
+// Extension server port
+const char kExtensionServerPort[] = "khadem.server.extension_port";
+
+// Whether MCP server is enabled
+const char kMCPServerEnabled[] = "khadem.server.mcp_enabled";
+
+// Whether server restart has been requested (auto-reset after restart)
+const char kRestartServerRequested[] = "khadem.server.restart_requested";
+
