...
+  }
+
+  // Pin native Khadem actions if their features are enabled
+  for (actions::ActionId id : khadem::kKhademNativeActionIds) {
+    const base::Feature* feature = khadem::GetFeatureForKhademAction(id);
