...
+ <p>Khadem is an AI-powered browser that lets you build and run agents to automate tedious tasks. It looks like Chrome but reimagined for the AI era.</p>
+ <div class="actions">
+  </div>
+</section>
+
...
+  <a class="btn btn-accent" href="https://bit.ly/Khadem-setup">Quick start guide</a>
...
+   <p class="muted" style="margin-top:.35rem">Navigate to <a href="chrome://settings/khadem"><code>chrome://settings/khadem</code></a> to configure your own API keys for various providers.</p>
...
+   Step 3: All done!
+  </div>
+  <div class="muted" style="margin-top:.4rem">Your ready to use Khadem, have fun! This page can be always accessed again at <a href="chrome://khadem-first-run"><code>chrome://khadem-first-run</code></a></div>
+ </div>
+</section>
+
+<section>
...
+   Discord
+  </a>
+  <a href="https://github.com/khadem-ai/Khadem">
+   <span class="icon" aria-hidden="true">
+    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
+     <title>GitHub</title>
...
+  public:
+   NxtscapeFirstRunUIConfig() : DefaultWebUIConfig("chrome", "khadem-first-run") {}
+};
+
