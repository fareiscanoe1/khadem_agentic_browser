...
+import '../khadem_prefs_page/khadem_prefs_page.js';
...
+          return {about: false, settings: false, nxtscape: false, khademPrefs: false};
         },
       },
...
+    const inKhademPrefs = routes.KHADEM_PREFS.contains(currentRoute);
+    this.showPages_ = {
+      about: inAbout,
+      settings: !inAbout && !inNxtscape && !inKhademPrefs,
+      nxtscape: inNxtscape,
+      khademPrefs: inKhademPrefs
+    };
   }
