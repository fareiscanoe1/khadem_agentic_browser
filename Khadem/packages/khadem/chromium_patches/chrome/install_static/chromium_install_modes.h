...
+            L"{CF887152-7CB8-4393-84CC-1BACF0EDE1D1}",  // Khadem app GUID.
+        .base_app_name = L"Khadem",              // A distinct base_app_name.
+        .base_app_id = L"Khadem",                // A distinct base_app_id.
