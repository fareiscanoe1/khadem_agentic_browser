#!/usr/bin/env python3
"""
Google Cloud Storage upload module for Khadem build artifacts
"""
...
def upload_to_gcs(
    ...
    Args:
        ctx: BuildContext with root_dir and khadem_version
    ...
    # Build GCS path: gs://khadem/resources/<version>/<platform>/
    gcs_prefix = f"resources/{ctx.khadem_version}/{platform_dir}"
