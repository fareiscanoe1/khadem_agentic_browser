...
Injects khadem browser version into extension manifests
"""
...
def inject_version_to_manifest(
    manifest_path: Path, browser_version: str, khadem_version: str
) -> bool:
    ...
    try:
        ...
        if "version" in manifest_data:
            ...
            formatted_version = f"{khadem_version}.0.0.0"
