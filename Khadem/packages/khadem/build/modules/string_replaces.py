#!/usr/bin/env python3
"""
String replacement module for Khadem build system
"""
...
branding_replacements = [
    (
        ...
        r"The Khadem Authors. All rights reserved.",
    ),
    (
        r"Google LLC. All rights reserved.",
        r"The Khadem Authors. All rights reserved.",
    ),
    (r"The Chromium Authors", r"Khadem Software Inc"),
    (r"Google Chrome", r"Khadem"),
    (r"(Google)(?! Play)", r"Khadem"),
    (r"Chromium", r"Khadem"),
    (r"Chrome", r"Khadem"),
]
